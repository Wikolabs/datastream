...
export const metadata: Metadata = { title:"DataStream — Pipeline de donnees IA en temps reel", description:"DataStream orchestre votre pipeline de donnees de bout en bout : ingestion, transformation, validation et livraison — sans DevOps, sans equipe data." };
